...
import com.interpreter.math.operations.doubleOperation.DoubleOperatorFactory;
import com.interpreter.math.operations.Operation;
import com.interpreter.math.operations.singleOperation.SingleOperationFactory;
        ...
        for(String element: elements) {
            if (MathElement.isValue(element)) {
                ...
                while (!operator.equals(Operators.LEFT_BRACKET.name())) {
                    ...
                    if (operators.isEmpty()) {
                        throw new IllegalStateException("Stack error no" + Operators.LEFT_BRACKET.name());
                    }
